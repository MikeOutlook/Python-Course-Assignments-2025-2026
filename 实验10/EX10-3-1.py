...
##、获取数据
DF1 =pd.read_excel("Census.xlsx","book1",index_col=0,engine='openpyxl')   # 读取数据文件中的book工作表到DF1，将本行代码补充完整
DF2 =pd.read_excel("Census.xlsx","education",index_col=0,engine='openpyxl')   # 读取数据文件中的education工作表到DF2，将本行代码补充完整
